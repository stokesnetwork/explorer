...
import { API_SERVER, STOKES_UNIT } from "../explorer_constants";
      ...
      <div className="cardBox mx-0">
        ...
        <table style={{ fontSize: "1rem" }}>
          ...
          <tr>
            ...
            <td className="">
              <div id="coins">
                {numberWithCommas(circCoins)} {STOKES_UNIT}
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td className="pt-1">100M {STOKES_UNIT}</td>
          </tr>
          <tr>
